...
class RobotState extends Component {
  ...
  getRobotState() {
    var pose_subsciber = new window.ROSLIB.Topic({
      ros: this.state.ros,
  ...
  getOrientationFromQuaternion(ros_orientation_qoaternion) {
    var q = new Three.Quaternion(
      ros_orientation_qoaternion.x,
      ros_orientation_qoaternion.y,
      ros_orientation_qoaternion.z,
      ros_orientation_qoaternion.w,
    );
    var RPY = new Three.Euler().setFromQuaternion(q);
    return RPY["_z"] * (100 / Math.PI);
  }
